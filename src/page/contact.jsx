    ...
    return (
        <div className='flex lg:flex-row flex-col-reverse h-screen'>
            ...
            <section className='h-full lg:w-4/5 bg-gray-200'>
                <Header text={"CONTACT"} />
                <div className='mx-9 2xl:mx-44 md:mx-24 h-3/5 font-sand flex flex-col md:flex-row justify-center gap-3'>
                    <div className='md:w-1/3 py-2 md:px-16 md:py-16 flex flex-col items-center border-2 border-gray-300 rounded-xl hover:bg-gray-300 duration-300 shadow-lg shadow-gray-300'>
                        <img className='h-12 mb-1 2xl:h-56 md:h-44 md:pb-12 object-contain' src="img/i-gmail.png" alt="" />
                    ...
                    <div className='md:w-1/3 py-2 md:px-16 md:py-16 flex flex-col items-center border-2 border-gray-300 rounded-xl hover:bg-gray-300 duration-300 shadow-lg shadow-gray-300'>
                        <img className='h-12 mb-1 2xl:h-56 md:h-44 md:pb-12 object-contain' src="img/i-github.png" alt="" />
                    ...
                    <div className='md:w-1/3 py-2 md:px-16 md:py-16 flex flex-col items-center border-2 border-gray-300 rounded-xl hover:bg-gray-300 duration-300 shadow-lg shadow-gray-300'>
                        <img className='h-12 mb-1 2xl:h-56 md:h-44 md:pb-12 object-contain' src="img/i-wa.png" alt="" />
